...
#     def __init__(self, num_topics=1, passes=20, text='text', cluster='cluster'):
...
class ClusterBasedLDA(TextCleaner):
    def __init__(self, num_topics=1, n_words_per_topic=5, passes=20, text='text', cluster='cluster'):
        super().__init__(stop_words_remove=False)
        self.num_topics = num_topics
